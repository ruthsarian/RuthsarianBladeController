...
The current major version of this PCB is 4. There are a few different minor versions (4.0, 4.1, 4.2). All minor versions are functionally identically and the differences between each only relate to resolving issues with the solder paste layer that would have a small impact on board assembly. 
