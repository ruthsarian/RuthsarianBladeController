...
#define DCP_BRIGHTNESS_LEVELS			4											// recommend this stay below 8, must have a value greater than 0
#define DCP_COLOR_COUNT					(uint16_t)(256 / DCP_BRIGHTNESS_LEVELS)		// the size of the color value space per brightness level. must be uint16_t because brightness could be 1
